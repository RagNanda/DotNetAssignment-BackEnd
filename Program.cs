...
var connectionString = builder.Configuration["ConnectionString:AssignmentDB"];

builder.Services.AddDbContext<ProjectContext>(opts => opts.UseMySql(connectionString,ServerVersion.AutoDetect(connectionString)));
